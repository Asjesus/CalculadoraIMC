...
namespace TesteXunit
{
    public class CalculoIMCTest
    {
        ...
        public void calcularIMC_RetornaResultado_ParaUmaListaDeValores(double peso, double altura, double resulatoEsperado) 
        {

            var resultadoIMC = Operacoes.CalcularIMC(peso, altura);

            Assert.Equal(resulatoEsperado, resultadoIMC);
        }
    }
}
